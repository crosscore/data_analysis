...
# データを加工
category_counts = df.groupby(['days', 'modified_category']).size().unstack(fill_value=0).reindex(columns=category_list, fill_value=0)
...
output_path = '../../data/img/analysis_by_total_view_count_modified_category/100%_stacked_area_chart/all/stacked_area_chart_modified.png'
