...
for user in df['user'].unique():
    ...
    ax.set_title(f'User {user} カテゴリー別視聴時間の割合')
    ax.set_ylabel('割合')
    ax.set_xlabel('Days')
    ...
    output_path = f'../../../data/img/normal/analysis_by_total_viewing_time/100%_stacked_area_chart/user/{user}_stacked_area_chart.png'
