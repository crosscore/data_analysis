...
df = pd.read_csv('../../data/csv/concat/MBapp_MBweb_PC_TV_rename_category.csv', dtype={'user': str})
print(df)
...
df_1st_half = df[(df['date'] >= start_date_exp1) & (df['date'] <= end_date_exp1)]
df_2nd_half = df[(df['date'] < start_date_exp1) | (df['date'] > end_date_exp1)]

df_1st_half['days'] = '1st_half'
df_2nd_half['days'] = '2nd_half'

# delete category 'TV'
# df_1st_half = df_1st_half[df_1st_half['category'] != 'TV']
# df_2nd_half = df_2nd_half[df_2nd_half['category'] != 'TV']
