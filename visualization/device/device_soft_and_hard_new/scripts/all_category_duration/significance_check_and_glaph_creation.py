...
plot_bar(combined_df, 'category', 'days', 'duration', '../../data/img/device_all_category_2exp/barplot.png', category_results)
plot_boxplot(combined_df, 'category', 'days', 'duration', '../../data/img/device_all_category_2exp/boxplot.png', category_results)
plot_scatter(combined_df, 'category', 'days', 'duration', '../../data/img/device_all_category_2exp/scatterplot.png', category_results)
plot_violin(combined_df, 'category', 'days', 'duration', '../../data/img/device_all_category_2exp/violinplot.png', category_results)
plot_histograms(combined_df, 'category', 'days', 'duration', '../../data/img/device_all_category_2exp/histogram.png')
plt.close()