#app_user_days_duration_sort.py
import pandas as pd
import numpy as np
...
for user, user_data in pivot_data.groupby(level=0):
    ...
    # グラフを保存
    graph_output_path = f'./img/app_user_days_duration_sort/user/Img_graph_app_user_{user}.png'
    ...
    ax_leg.axis('off')
    legend_output_path = f'./img/app_user_days_duration_sort/user/Img_legend_app_user_{user}.png'
