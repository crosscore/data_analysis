...
plot_bar(combined_df, 'category', 'period', 'duration', '../data/img/MobileApp_2exp_no_sum/barplot.png', category_results)
plot_boxplot(combined_df, 'category', 'period', 'duration', '../data/img/MobileApp_2exp_no_sum/boxplot.png', category_results)
plot_scatter(combined_df, 'category', 'period', 'duration', '../data/img/MobileApp_2exp_no_sum/scatterplot.png', category_results)
plot_violin(combined_df, 'category', 'period', 'duration', '../data/img/MobileApp_2exp_no_sum/violinplot.png', category_results)
plot_histograms(combined_df, 'category', 'period', 'duration', '../data/img/MobileApp_2exp_no_sum/histogram.png')
plt.close()