...
plot_percentage_category_duration(df_app, 'app_100%_stacked_area_chart_duration.png')
plot_percentage_category_duration(df_tv, 'tv_100%_stacked_area_chart_duration.png')
