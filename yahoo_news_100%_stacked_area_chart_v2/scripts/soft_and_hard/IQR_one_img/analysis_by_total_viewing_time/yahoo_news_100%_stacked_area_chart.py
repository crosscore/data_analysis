...
ax.set_title('Percentage of viewing time by category for all users')
...
output_path = '../../../../data/img/soft_and_hard/iqr_one_img/analysis_by_total_viewing_time/100%_stacked_area_chart/all/stacked_area_chart.png'
