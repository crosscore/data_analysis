...
ax.set_title(f'All users viewing time by category')
...
output_path = f'../../../../data/img/soft_and_hard/iqr_one_img/analysis_by_total_viewing_time/bar_chart/all/bar_chart.png'
