...
ax.set_title(f'All users View count by category')
...
output_path = '../../../../data/img/soft_and_hard/iqr_one_img/analysis_by_total_view_count/bar_chart/all/bar_chart.png'
