...
plot_bar(combined_df, 'category', 'days', 'duration', '../../data/img/all_category_2exp_no_sum_del_TV/barplot.png', category_results)
plot_boxplot(combined_df, 'category', 'days', 'duration', '../../data/img/all_category_2exp_no_sum_del_TV/boxplot.png', category_results)
plot_scatter(combined_df, 'category', 'days', 'duration', '../../data/img/all_category_2exp_no_sum_del_TV/scatterplot.png', category_results)
plot_violin(combined_df, 'category', 'days', 'duration', '../../data/img/all_category_2exp_no_sum_del_TV/violinplot.png', category_results)
plot_histograms(combined_df, 'category', 'days', 'duration', '../../data/img/all_category_2exp_no_sum_del_TV/histogram.png')
plt.close()