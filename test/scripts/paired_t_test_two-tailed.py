...
#exam1_scoresとexam2_scoresにおいて、対応のあるt検定(両側検定)を行う
print('================================================')
print('exam1_scoresとexam2_scoresにおいて、対応のあるt検定(両側検定)を行う')
t, p = stats.ttest_rel(exam1_scores, exam2_scores)
print(f't値: {t}')
print(f'p値: {p}')
print(f'{p} < {alpha} : 有意差あり' if p < alpha else f'{p} > {alpha} : 有意差なし')