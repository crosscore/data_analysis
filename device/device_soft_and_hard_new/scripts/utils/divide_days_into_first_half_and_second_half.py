...
df = pd.read_csv('../../data/csv/original/device_add_days.csv', dtype={'user': str})
...
df.to_csv('../../data/csv/1st_half_and_2nd_half/device_original_1st_half_and_2nd_half.csv', index=False)
