...
def plot_scatter(df, category_col, period_col, duration_col, output_file, category_results):
    ...
    fig, axes = plt.subplots(nrows=n_rows, ncols=n_cols, figsize=(fig_width, 24), sharey=True)
    axes = axes.flatten()
    x_points = {periods[0]: 0, periods[1]: 0.5}
    for i, category in enumerate(categories):
        ax = axes[i]
        category_df = df[df[category_col] == category]
...
df_1st_half_sum = df[df['days'] == '1st_half']
df_2nd_half_sum = df[df['days'] == '2nd_half']
...
plot_bar(combined_df, 'category', 'days', 'duration', '../../data/img/device_all_category_2exp_no_sum/barplot.png', category_results)
plot_boxplot(combined_df, 'category', 'days', 'duration', '../../data/img/device_all_category_2exp_no_sum/boxplot.png', category_results)
plot_scatter(combined_df, 'category', 'days', 'duration', '../../data/img/device_all_category_2exp_no_sum/scatterplot.png', category_results)
plot_violin(combined_df, 'category', 'days', 'duration', '../../data/img/device_all_category_2exp_no_sum/violinplot.png', category_results)
plot_histograms(combined_df, 'category', 'days', 'duration', '../../data/img/device_all_category_2exp_no_sum/histogram.png')
plt.close()