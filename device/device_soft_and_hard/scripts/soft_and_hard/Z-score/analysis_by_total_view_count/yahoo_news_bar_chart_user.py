...
for user in df['user'].unique():
    ...
    ax.set_title(f'User {user} Number of views by category')
    ...
    output_path = f'../../../../data/img/soft_and_hard/z-score/analysis_by_total_view_count/bar_chart/user/{user}_bar_chart.png'
